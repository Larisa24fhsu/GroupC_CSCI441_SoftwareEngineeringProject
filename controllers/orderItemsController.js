...
// Function to handle GET request to get all item orders
...
// Function to handle POST request to create a new item order
const createOrderItems = async (req, res) => {
  ...
  try {
    ...
    console.log("Inserted OrderItem",result.rows[0]);
...
module.exports = { getAllOrderItems, createOrderItems };
